              ...
              <div className="flex flex-col gap-2 px-6 pb-6">
                ...
                <div className="flex w-full flex-row items-center gap-4">
                  ...
                  {secondaryAction && secondaryLabel && (
                    <Button disabled={disabled} label={secondaryLabel} onClick={handleSecondaryAction} outline />
                  )}
                  {/* メインボタン */}
                  <Button disabled={disabled} label={primaryLabel} onClick={handleSubmit} del={del} />
                </div>
